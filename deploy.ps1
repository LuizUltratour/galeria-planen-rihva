<#
  deploy.ps1 — Deploy da galeria Planen Rihva para o AWS S3.
...
$Bucket = 's3://skylineip/Tour Virtual/planen/galeria-planen-rihva'
...
Write-Host "Base: https://skylineip.s3.sa-east-1.amazonaws.com/Tour+Virtual/planen/galeria-planen-rihva/" -ForegroundColor DarkGray
